                ...
                MaterialPageRoute(
                  builder: (context) => PaymentScreen(
                    order: OrderModel(
                      ...
                      destinationLat: markers.firstWhere((m) => m.markerId.value == 'destination').position.latitude,
                      destinationLng: markers.firstWhere((m) => m.markerId.value == 'destination').position.longitude,
                      status: 'pending',
